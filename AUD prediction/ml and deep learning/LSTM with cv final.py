...
targets = pd.read_excel('F:/AUD files for LSTM/MTech project final susma/Test/labels test.xlsx')
...
seq_f=[None]*kk
sequences = list()
path = 'F:/AUD files for LSTM/MTech project final susma/Test/Data__'
...
y_pred = classifier.predict(X_testmod)
...
my_classifier=KerasClassifier(build_fn=build_classifier,epochs=20,batch_size=24)
